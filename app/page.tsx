...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative px-6 overflow-hidden h-screen min-h-[520px] flex items-center">
      ...
      <section className="px-6 py-20 bg-white-200">
        <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Complete Cleanup</h3>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Personalized decorations and themes tailored to your unique vision</p>
            </div>
      ...
      {/* Packages Section */}
      <section id="packages" className="px-6 py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-4 bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
                <div className="h-10 w-10 rounded-xl bg-purple-100 flex items-center justify-center">
                  <svg className="h-5 w-5 text-purple-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M20 11.5A8.5 8.5 0 1111.5 3a8.5 8.5 0 018.5 8.5z" />
                    <path d="M5 19l1.5-4.5" />
                    <path d="M8 13c1 2 3 3 5 3" />
                  </svg>
                </div>
                <div>
      ...
      <footer className="bg-white border-t border-gray-200 px-6 py-8">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between">
          <div className="text-2xl bg-gradient-to-r from-fuchsia-500 to-amber-500 bg-clip-text text-transparent">BookMyBirthdayParty
          </div>
